...
//go:generate swagger generate server --target ../../gen --name UserSignUpApis --spec ../../swagger/usersignup.yaml

func configureFlags(api *operations.UserSignUpApisAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.UserSignUpApisAPI) http.Handler {
